-- CreateEnum
CREATE TYPE "TableType" AS ENUM ('VVIP', 'VIP');

-- CreateEnum
CREATE TYPE "PaymentStatus" AS ENUM ('AVAILABLE', 'BOOKED', 'DEPOSIT_PAID', 'FULLY_PAID');
...
CREATE TABLE "Reservation" (
    ...
    "paymentStatus" "PaymentStatus" NOT NULL DEFAULT 'AVAILABLE',
    "notes" TEXT,
